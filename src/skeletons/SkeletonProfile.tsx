  ...
  return (
    <>
      <section className="profile">
        <div className="background__container h-[168px] 2xl:h-[288px] xl:h-[288px] lg:h-[288px] md:h-[248px] sm:h-[168px] skeleton">
        ...
        <div className="shadow">
          ...
          <details className="profile__about hidden xl:block lg:block md:hidden sm:hidden" id="profile__about" open>
